...
const ProductDetails = () => {
  ...
  useEffect(() => {
    ...
    const foundProduct = storedItems.find((item) => item.id === parseInt(productId));
    ...
    <img src={product.image} alt={product.name} className="main-image" />
      ...
      <div className="product-info">
        ...
        <div className="product-description">
          <h3>Description:</h3>
          <p>{product.description || "Delicious handcrafted cookie made with love and top-quality ingredients."}</p>
        </div>
      </div>
    </div>
  );
